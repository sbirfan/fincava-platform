// Contact details below are placeholders pending confirmation from Irfan —
// flagged in the Phase 1 exit-test report rather than invented silently.
...
const CONTACT_EMAIL = 'hello@fincava.com';
const WHATSAPP_PLACEHOLDER = '+1 (000) 000-0000';
    ...
    <div className="max-w-2xl mx-auto px-6 md:px-10 py-14">
      ...
      <div className="bg-fc-white border border-fc-line rounded-fc-lg shadow-fc-1 p-6 flex flex-col gap-4">
        ...
        <div>
          ...
          <span className="text-sm text-fc-ink-2">{WHATSAPP_PLACEHOLDER}</span>
        </div>
        <div>
          <div className="text-xs font-semibold text-fc-ink-3 uppercase tracking-wide mb-1">
            Location
